...
if [ -e "$APP_START_FILE" ] ; then
	...
	sed -i ".bak" -e "s,$ANDROID_APPCENTER_SECRET_PLACEHOLDER,$ANDROID_APPCENTER_SECRET,g" $APP_START_FILE
	# echo "Updating iOS AppCenter secret"
	# sed -i ".bak" -e "s,$IOS_APPCENTER_SECRET_PLACEHOLDER,$IOS_APPCENTER_SECRET,g" $APP_START_FILE
